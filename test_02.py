...
# Usage: python test_02.py <model_name> <experiment_id> <experiment_condition> <name of input file> <name of output file>
# Example: python test_02.py model1 TGA 10 sample_input.txt result_model1.json
...
if __name__ == "__main__":
    # Validate arguments
    if len(sys.argv) != 6:
        print("Usage: python test_02.py <model_name> <experiment_id> <experiment_condition> <name of input file> <name of output file>")
        sys.exit(1)
